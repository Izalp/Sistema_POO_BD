...
public abstract class Database {
    ...
    private static final String aluno = "root"; // usuario de instancia local do servidor
    private static final String professor = "root"; // usuario de instancia local do servidor
    private static final String password = "rootroot"; // senha do usuario da instancia local do servidor
    private static final String database = "sistema"; // nome do banco de dados a ser utilizado
    ...
    public void connect(){
        try{
            ...
            connection = DriverManager.getConnection(url,professor,password);
