...
public class Main {
    public static void main(String[] args) {
        ...
        String entrada00; //para cadastro de escola
        int entrada01;//para menu 1

        System.out.println("\nBEM-VINDO AO SISTEMA:\n"); //acessar o sistema com o id da escola (mudar dps)
        System.out.println("Por favor, antes de iniciar, você já realizou o cadastro da escola no sistema?");
        entrada00 = sc.nextLine();

        if (Objects.equals(entrada00, "não")) {
        ...
        /*else if (Objects.equals(entrada00, "sim")){
            System.out.println("Por favor, insira o número de identificação da escola cadastrada:");
            int acesso;
            acesso = sc.nextInt();
        ...
        while (flag) {
            ...
            switch (entrada01) {
                ...
                case 4 ->
                        escolaBD.researchEscola(); // BUSCANDO DADOS DE ESCOLA CADASTRADA
                case 5 ->
                        diretorBD.researchDiretor(); // BUSCANDO DADOS DE DIRETOR CADASTRADO
                case 6 ->
                        coordenadorBD.researchCoordenador(); //BUSCANDO DADOS DE COORDENADOR CADASTRADO
                case 7 -> {
