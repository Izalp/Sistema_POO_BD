    ...
    public static void main(String[] args) {
        ...
        if(Objects.equals(entrada00, "não")) {
            ...
            while (flag) {
                ...
                System.out.println("3 - Busca de dados de escolas cadastradas");
                System.out.println("4 - Atualização de dados das escolas");
                System.out.println("5 - Cancelamento de cadastro de escola");
                ...
                switch (entrada01) {
                    ...
                    case 3 ->//-------------BUSCANDO DADOS DE ESCOLA CADASTRADA--------------------------------
                            escolaBD.researchEscola();
                    case 4 ->{ //----------ATUALIZANDO LOCALIZAÇÃO OU CONTATO DA ESCOLA CADASTRADA--------------
                        System.out.println("\nMENU de atualização:\n");
                        System.out.println("1 - Atualizar endereço");
                        System.out.println("2 - Atualizar contato");
                        System.out.println("3 - Sair do menu de atualização");
                    ...
                    case 5 ->{ //----------------EXCLUINDO ESCOLA CADASTRADA------------------------------------
