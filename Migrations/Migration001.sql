...
CREATE TABLE
    IF NOT EXISTS `mydb`.`Coordenador` (
        ...
        CONSTRAINT `fk_Coordenador_Escola1` FOREIGN KEY (`Escola_idEscola`) REFERENCES `mydb`.`Escola` (`idEscola`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `mydb`.`Turma` (
        ...
        INDEX `fk_Turma_Coordenador1_idx` (
            `Coordenador_idCoordenador` ASC
        ) VISIBLE,
        CONSTRAINT `fk_Turma_Escola1` FOREIGN KEY (`Escola_idEscola`) REFERENCES `mydb`.`Escola` (`idEscola`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_Turma_Coordenador1` FOREIGN KEY (`Coordenador_idCoordenador`) REFERENCES `mydb`.`Coordenador` (`idCoordenador`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `mydb`.`Aluno` (
        ...
        CONSTRAINT `fk_Aluno_Turma1` FOREIGN KEY (`Turma_idTurma`) REFERENCES `mydb`.`Turma` (`idTurma`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_Aluno_Escola1` FOREIGN KEY (`Escola_idEscola`) REFERENCES `mydb`.`Escola` (`idEscola`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `mydb`.`Aluno_has_Professor` (
        `Aluno_matriculaAluno` INT NOT NULL,
        `Professor_idProfessor` INT NOT NULL,
        PRIMARY KEY (
            `Aluno_matriculaAluno`,
        ...
        CONSTRAINT `fk_Aluno_has_Professor_Aluno` FOREIGN KEY (`Aluno_matriculaAluno`) REFERENCES `mydb`.`Aluno` (`matriculaAluno`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_Aluno_has_Professor_Professor1` FOREIGN KEY (`Professor_idProfessor`) REFERENCES `mydb`.`Professor` (`idProfessor`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `mydb`.`Professor_has_Turma` (
        `Professor_idProfessor` INT NOT NULL,
        ...
        CONSTRAINT `fk_Professor_has_Turma_Professor1` FOREIGN KEY (`Professor_idProfessor`) REFERENCES `mydb`.`Professor` (`idProfessor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_Professor_has_Turma_Turma1` FOREIGN KEY (`Turma_idTurma`) REFERENCES `mydb`.`Turma` (`idTurma`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `mydb`.`Professor_has_Escola` (
        `Professor_idProfessor` INT NOT NULL,
        ...
        CONSTRAINT `fk_Professor_has_Escola_Professor1` FOREIGN KEY (`Professor_idProfessor`) REFERENCES `mydb`.`Professor` (`idProfessor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_Professor_has_Escola_Escola1` FOREIGN KEY (`Escola_idEscola`) REFERENCES `mydb`.`Escola` (`idEscola`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `mydb`.`Diretor` (
        ...
        CONSTRAINT `fk_Diretor_Escola1` FOREIGN KEY (`Escola_idEscola`) REFERENCES `mydb`.`Escola` (`idEscola`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
SELECT * FROM `Professor_has_Turmas`;